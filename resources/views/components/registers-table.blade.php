...
<table class="table table-striped mt-2 border">
    ...
    <tbody>
        @foreach ($registers as $register)
            <tr>
                <!--register id-->
                <th scope="row" class="align-middle">{{ $register->id }}</th>
                
                <!--register first name-->
                <td class="align-middle"><a href="{{ route('admin.registers.show', $register->id) }}" style="text-decoration: none;" >{{ $register->first_name }} </a></td>
                
                <!--register last name-->
                <td class="align-middle">{{ $register->last_name }}</td>
               
                <!--register joined-->
                <td class="align-middle">{{ $register->created_at->diffForHumans() }}</td>

                <!--register phone-->
                <td class="align-middle">{{ $register->phone_number }}</td>
            
                <!--register email-->
                <td class="align-middle">{{ $register->email }}</td>
                ...
                <td class="align-middle">
                    <div style="display: flex;" class="d-flex">
                        ...
                        <a type="button" class="m-1 d-flex justify-content-center" href="{{ route('admin.registers.show', $register->id) }}"data-bs-toggle="tooltip" data-bs-placement="top" title="show register information">
                        ...
                        <a type="button" class="m-1 d-flex justify-content-center " href="{{ route('admin.registers.edit', $register->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="edit register information">
                        ...
                        <!--delete register form the database-->
                        <a type="button" class="m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="delete" data-bs-toggle="tooltip" data-bs-placement="top" title="delete register from the system">
