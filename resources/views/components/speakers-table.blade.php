...
<table class="table table-striped mt-2 border">
    ...
    <tbody>
        @foreach ($speakers as $speaker)
            <tr>
                <!--speaker id-->
                <th scope="row" class="align-middle">{{ $speaker->id }}</th>
                
                <!--speaker first name-->
                <td class="align-middle"><a href="{{ route('admin.speakers.show', $speaker->id) }}" style="text-decoration: none;" >{{ $speaker->first_name }} </a></td>
                
                <!--speaker last name-->
                <td class="align-middle">{{ $speaker->last_name }}</td>
               
                <!--speaker joined-->
                <td class="align-middle">{{ $speaker->created_at->diffForHumans() }}</td>

                <!--speaker phone-->
                <td class="align-middle">{{ $speaker->phone_number }}</td>
                ...
                <td class="align-middle">
                    <div style="display: flex;" class="d-flex">
                        ...
                        <a type="button" class="m-1 d-flex justify-content-center" href="{{ route('admin.speakers.show', $speaker->id) }}"data-bs-toggle="tooltip" data-bs-placement="top" title="show speaker information">
                        ...
                        <a type="button" class="m-1 d-flex justify-content-center " href="{{ route('admin.speakers.edit', $speaker->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="edit speaker information">
                        ...
                        <!--delete speaker form the database-->
                        <a type="button" class="m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="delete" data-bs-toggle="tooltip" data-bs-placement="top" title="delete speaker from the system">
