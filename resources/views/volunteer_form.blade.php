                ...
                <div class="">
                    ...
                    <form id="signUpForm" class="w-100 rounded-1 p-4 border bg-white" action='{{ route("storeVolunteer") }}' method="POST" enctype="multipart/form-data">
                        ...
                        <div class="step">
                            ...
                            <label class="d-block mb-4">
                                <span class="form-label d-block"><span class="me-2 text-danger">.</span><strong>Why do you want to be a volunteer in TEDxJumeirahbeachpark?</strong></span>
                                <textarea rows="4" cols="50" name="question_2" type="text" class="form-control" placeholder="Because ...">{{ old('question_2') }}</textarea>
                            </label>

                            <!--hours-->
                            <label class="d-block mb-4">
                                <span class="form-label d-block"><span class="me-2 text-danger">.</span><strong>How many hours can you contribute per week?</strong></span>
                            ...
                            <!--what is your skills -->
                            <label class="d-block mb-4">
                                <div class="form-label d-block"><span class="me-2 text-danger">.</span><strong>What is your skills?</strong></div>
                            ...
                            <label class="d-block mb-4">
                                <span class="form-label d-block"><span class="me-2 text-danger">.</span><strong>Descripe yourself and what you will add to our team?</strong></span>
